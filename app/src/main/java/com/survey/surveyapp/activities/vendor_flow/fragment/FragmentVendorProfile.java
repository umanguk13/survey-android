...
public class FragmentVendorProfile extends Fragment {
    ...
    @BindView(R.id.fragment_vendor_profile_textview_user_name)
    TextView mTextViewUsername;

    @BindView(R.id.fragment_vendor_profile_textview_member_since)
    TextView mTextViewMemberSince;

    @BindView(R.id.fragment_vendor_profile_edittext_username)
    TextInputEditText mEditTextUsername;

    @BindView(R.id.fragment_vendor_profile_edittext_user_email)
    TextInputEditText mEditTextUserEmail;

    @BindView(R.id.fragment_vendor_profile_edittext_gender)
    TextInputEditText mEditTextUserGender;

    @BindView(R.id.fragment_vendor_profile_edittext_phone_number)
    TextInputEditText mEditTextUserPhoneNumber;

    @BindView(R.id.fragment_vendor_profile_edittext_address)
    ...
    public void setUserData(VoResponseFetchUserProfileData voResponseFetchUserProfileData) {
    ...
    public void fetchUserProfile() {
        ...
        mActivityVendorMain.mMyService.fetchUserProfile(mActivityVendorMain.mUtility.getAppPrefString(TagValues.PREF_USER_ACCESS_TOKEN),
                mActivityVendorMain.mUtility.getAppPrefString(TagValues.PREF_USER_ID), new MyService.ServiceCallback<VoResponseFetchUserProfile>() {
                    @Override
