...
public class VoResponseCurrentSurveyData implements Serializable {
    ...
    private VoResponseCurrentSurveyCategory survey_category;
    ...
    public VoResponseCurrentSurveyCategory getSurvey_category() {
        return survey_category;
    }

    public void setSurvey_category(VoResponseCurrentSurveyCategory survey_category) {
        this.survey_category = survey_category;
    }

    public class VoResponseCurrentSurveyCategory implements Serializable {
        private String id = "";
        private String name = "";
